...
import com.rudy.stockmarketapp.di.AppModule_ProvideStockApiFactory;
import com.rudy.stockmarketapp.di.AppModule_ProvideStockDatabaseFactory;
import com.rudy.stockmarketapp.presentation.company_info.CompanyInfoViewModel;
import com.rudy.stockmarketapp.presentation.company_info.CompanyInfoViewModel_HiltModules_KeyModule_ProvideFactory;
import com.rudy.stockmarketapp.presentation.company_listings.CompanyListingsViewModel;
import com.rudy.stockmarketapp.presentation.company_listings.CompanyListingsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerStockApplication_HiltComponents_SingletonC extends StockApplication_HiltComponents.SingletonC {
  ...
  private static final class ViewModelCImpl extends StockApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.rudy.stockmarketapp.presentation.company_info.CompanyInfoViewModel", ((Provider) companyInfoViewModelProvider)).put("com.rudy.stockmarketapp.presentation.company_listings.CompanyListingsViewModel", ((Provider) companyListingsViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.rudy.stockmarketapp.presentation.company_info.CompanyInfoViewModel 
          return (T) new CompanyInfoViewModel(viewModelCImpl.savedStateHandle, singletonC.stockRepositoryImplProvider.get());

          case 1: // com.rudy.stockmarketapp.presentation.company_listings.CompanyListingsViewModel 
  ...
  private static final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        case 0: // com.rudy.stockmarketapp.data.repository.StockRepositoryImpl 
        ...
        case 1: // com.rudy.stockmarketapp.data.remote.StockApi 
        return (T) AppModule_ProvideStockApiFactory.provideStockApi();

        case 2: // com.rudy.stockmarketapp.data.local.StockDatabase 
        ...
        case 3: // com.rudy.stockmarketapp.data.csv.CompanyListingsParser 
        return (T) new CompanyListingsParser();

        case 4: // com.rudy.stockmarketapp.data.csv.IntradayInfoParser 
